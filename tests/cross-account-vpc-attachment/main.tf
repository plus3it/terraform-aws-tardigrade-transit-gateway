...
module "vpc_member" {
  source = "git::https://github.com/terraform-aws-modules/terraform-aws-vpc.git?ref=v3.5.0"
...
module "vpc_owner" {
  source = "git::https://github.com/terraform-aws-modules/terraform-aws-vpc.git?ref=v3.4.0"
  providers = {
    aws = aws.owner
  }
